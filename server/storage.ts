    ...
    const sampleEntries = [
      {
        ...
        dataVerifier: "Arun",
        dataApprover: "Priya",
        dataAssurer: "Narendra",
        dataAudited: "Yes"
      },
      {
        businessCenter: "india",
        operationSite: "west",
        profitCenter: "gujarat",
        plantName: "dahej",
        ...
        quantity: 500,
        costInr: 45000,
        vendorName: "FuelTech Solutions",
        emissionFactor: 2.7,
        calorificValue: 1,
        density: 0.85,
        remarks: "Generator fuel consumption",
        completionStatus: "50%",
        dataOwner: "Pooja",
        dataVerifier: "Arun",
        dataApprover: "Priya",
